            ...
            Blog
                ...
                <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3
                 sm:gap-6">
                    ...
                    <Footer.LinkGroup col>
                        <Footer.Link href='https://github.com/umerxgit2004' target='_blank' rel="noopener noreferrer">
                           Github
                        </Footer.Link>
                        <Footer.Link href='https://www.linkedin.com/in/umer174' target='_blank' rel="noopener noreferrer">
                            LinkedIn
                        </Footer.Link>
                    </Footer.LinkGroup>
                    </div>
             ...
             <div className="w-full sm:flex sm:items-center sm:justify-between">
                <Footer.Copyright href='#' by="MyMedia's blog" year={new Date().getFullYear()}/>
